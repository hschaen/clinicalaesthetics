...
$form_mail[] = array( "name" => "Sender_E-mail", "text" => "Sender\'s E-mail",  "type" => "sender's email", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Generic_E-mail", "text" => "Generic E-mail",  "type" => "generic email", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Special_Text", "text" => "Special Text( ,./<>?;:\'\"[]{}\\|`~!@#$%^&*()_+=-)",  "type" => "text", "required" => "" ) ;
$form_mail[] = array( "name" => "Radio", "text" => "Radio",  "type" => "radio", "required" => "Required" ) ;
$form_mail[] = array( "name" => "CheckBox", "text" => "CheckBox",  "type" => "checkbox", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Select_Credit_Card", "text" => "Select Credit Card",  "type" => "select", "required" => "" ) ;
$form_mail[] = array( "name" => "TextArea", "text" => "TextArea",  "type" => "textarea", "required" => "" ) ;
$form_mail[] = array( "name" => "Attachment", "text" => "Attachment",  "type" => "attachment", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Password", "text" => "Password",  "type" => "password", "required" => "" ) ;
$form_mail[] = array( "name" => "Credit_Card_Expiry_Date", "text" => "Credit Card Expiry Date",  "type" => "creditcard(mm-yyyy)", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Credit_Card#", "text" => "Credit Card#",  "type" => "creditcard#", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Generic_Date_Selection_1", "text" => "Generic Date Selection 1",  "type" => "date(mm-dd-yyyy)", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Generic_Date_Selection_2", "text" => "Generic Date Selection 2",  "type" => "date(mm-yyyy)", "required" => "" ) ;
$form_mail[] = array( "name" => "Generic_Time_Selection_1", "text" => "Generic Time Selection 1",  "type" => "time(hh:mm:ss)", "required" => "Required" ) ;
$form_mail[] = array( "name" => "Generic_Time_Selection_2", "text" => "Generic Time Selection 2",  "type" => "time(hh:mm)", "required" => "" ) ;


// -- Create new vars for checkPass() & sendFormMail() --
$CheckBox = array();
$CheckBox[0]=$HTTP_POST_VARS[ "Checkbox01_CheckBox"];
$CheckBox[1]=$HTTP_POST_VARS[ "Checkbox02_CheckBox"];
$CheckBox[2]=$HTTP_POST_VARS[ "Checkbox03_CheckBox"];
$CheckBox[3]=$HTTP_POST_VARS[ "Checkbox04_CheckBox"];
$CheckBox[4]=$HTTP_POST_VARS[ "Checkbox05_CheckBox"];
$HTTP_POST_VARS[ "CheckBox" ] = join( "\n", $CheckBox);

 $HTTP_POST_VARS[ "Credit_Card_Expiry_Date" ] = ( $HTTP_POST_VARS[ "Credit_Card_Expiry_Date_YYYY" ] && $HTTP_POST_VARS[ "Credit_Card_Expiry_Date_MM" ]  ) 
                                                          ?  $HTTP_POST_VARS[ "Credit_Card_Expiry_Date_YYYY" ] . "-" .  $HTTP_POST_VARS[ "Credit_Card_Expiry_Date_MM" ] 
                                                          : "" ;
 $HTTP_POST_VARS[ "Generic_Date_Selection_1" ] = ( $HTTP_POST_VARS[ "Generic_Date_Selection_1_YYYY" ] && $HTTP_POST_VARS[ "Generic_Date_Selection_1_MM" ] && $HTTP_POST_VARS[ "Generic_Date_Selection_1_DD" ] ) 
                                                          ?  $HTTP_POST_VARS[ "Generic_Date_Selection_1_YYYY" ] . "-" .  $HTTP_POST_VARS[ "Generic_Date_Selection_1_MM" ]  . "-" .  $HTTP_POST_VARS[ "Generic_Date_Selection_1_DD" ]
                                                          : "" ;
 $HTTP_POST_VARS[ "Generic_Date_Selection_2" ] = ( $HTTP_POST_VARS[ "Generic_Date_Selection_2_YYYY" ] && $HTTP_POST_VARS[ "Generic_Date_Selection_2_MM" ]  ) 
                                                          ?  $HTTP_POST_VARS[ "Generic_Date_Selection_2_YYYY" ] . "-" .  $HTTP_POST_VARS[ "Generic_Date_Selection_2_MM" ] 
                                                          : "" ;
 $HTTP_POST_VARS[ "Generic_Time_Selection_1" ] = ( $HTTP_POST_VARS[ "Generic_Time_Selection_1_HH" ] && $HTTP_POST_VARS[ "Generic_Time_Selection_1_MM" ] && $HTTP_POST_VARS[ "Generic_Time_Selection_1_SS" ] ) 
                                                          ? $HTTP_POST_VARS[ "Generic_Time_Selection_1_HH" ] . ":" .  $HTTP_POST_VARS[ "Generic_Time_Selection_1_MM" ] . ":" . $HTTP_POST_VARS[ "Generic_Time_Selection_1_SS" ]
                                                          : "" ;
 $HTTP_POST_VARS[ "Generic_Time_Selection_2" ] = ( $HTTP_POST_VARS[ "Generic_Time_Selection_2_HH" ] && $HTTP_POST_VARS[ "Generic_Time_Selection_2_MM" ] ) 
                                                          ? $HTTP_POST_VARS[ "Generic_Time_Selection_2_HH" ] . ":" .  $HTTP_POST_VARS[ "Generic_Time_Selection_2_MM" ]
                                                          : "" ;
...
if( $HTTP_POST_VARS["formmail_submit"] ){
	$sErr = checkPass();
	if( ! $sErr ){
		sendFormMail( $form_mail, "test.txt") ;
		$isHideForm = true;
...
function mailReport( $content = "", $from = "" ){
	mail( ADMIN_MAIN, "Error@" . HOST_NAME . PHP_SELF, $content, "From:$from" );
}
...
function    mailAttachments( $to = "" , $subject = "" , $message = "" , $from = "support@lynx.net" , $charset = "iso-8859-1", $cc = "" , $bcc = "" ){ 
    global    $HTTP_POST_FILES ; 
        ...
        foreach( $HTTP_POST_FILES as $aFile ){ 
         ...
         mail( $to, $subject, $sSource, $headers  );  
